...
def generate_and_analyze_ion_trajectory(model_path, protein_coords_file, n_steps=44000, temperature=0.1):
    """
...
def main_with_trajectory_generation(ion_coords_file, ion_vels_file, ion_forces_file, protein_coords_file):
    ...
    traj_pos, traj_vel, traj_force, analysis = generate_and_analyze_ion_trajectory(
        ...
        n_steps=13000,  # 13,000 timesteps for 13 ps
        temperature=0.1
    )
...
def create_trajectory_animation(trajectory, protein_coords, output_file='trajectory_animation.gif', fps=10):
    """
